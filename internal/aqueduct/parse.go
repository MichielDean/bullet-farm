...
// It includes a sentinel comment so ensureCataractaeIntegrity can verify
// the file was generated by the pipeline, even when the INSTRUCTIONS.md
// delegates signaling to an injected skill file instead of inlining the
// command. The sentinel form (cistern-integrity-sentinel) is distinct from
// the literal "ct droplet pass" command to avoid LLM misinterpretation
// and false positives from prose mentions of the command.
const generatedHeader = "<!-- generated by ct cataractae generate — edit PERSONA.md and INSTRUCTIONS.md instead -->\n<!-- cistern-integrity-sentinel: ct droplet pass -->\n\n"
...
// by instructionsFile (e.g. "AGENTS.md"); pass "" to default to "AGENTS.md".
//
