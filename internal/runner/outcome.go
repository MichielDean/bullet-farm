...
func (o *Outcome) Validate() error {
	switch o.Result {
	case ResultPass, ResultFail, ResultRevision, ResultEscalate:
		return nil
	case "":
		return fmt.Errorf("outcome: result is required")
	default:
		return fmt.Errorf("outcome: unknown result %q (want pass|fail|revision|escalate)", o.Result)
	}
}

// RouteField returns the workflow routing field name for this outcome.
// Maps result → on_pass, on_fail, on_revision, on_escalate.
