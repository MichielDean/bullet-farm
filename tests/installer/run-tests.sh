...
_install_skill_stubs() {
    local _skills="cistern-architect cistern-droplet-state cistern-git cistern-github cistern-reviewer cistern-signaling cistern-test-runner cistern-diff-reader code-simplifier critical-code-reviewer"
